...
const ROLES: Role[] = ["Owner", "Admin", "Team Leader", "Member", "Watcher"];

type Action = "invite" | "changeRole" | "remove" | "delete" | "edit";
          ...
          resolve([
            {
              ...
              members: [
                ...
                { id: "2", name: "Jane Smith", email: "jane@example.com", role: "Admin", avatar: "/placeholder.svg" },
                { id: "3", name: "You", email: "you@example.com", role: currentUserRole, avatar: "/placeholder.svg" },
              ],
            },
            {
              id: "2",
              ...
              members: [
                ...
                { id: "5", name: "You", email: "you@example.com", role: currentUserRole, avatar: "/placeholder.svg" },
              ],
            },
          ]);
        }, 1000);
